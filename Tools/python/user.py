...
if os.environ['USER'] in ['schoef', 'rschoefbeck', 'schoefbeck']:
    ...
    skim_output_directory      = "/afs/hephy.at/data/cms01/TTXPheno/skims/" # where you want the flat ntuples to go
...
if os.environ['USER'] in ['llechner']:
    ...
    cache_directory        = "/afs/hephy.at/data/llechner01/TTXPheno/cache/"
