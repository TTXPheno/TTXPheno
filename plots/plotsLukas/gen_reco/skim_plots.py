...
params.append( [{'legendText':'ttZ', 'WC':{}, 'color':ROOT.kBlack}] )
...
#ttSample = getattr( loadedSamples, ttSampleName + '_' + args.detector )
...
#        if not args.noninfoSignal and i_h == histoIndexNonInfo: continue
      ...
      for j_hi, hi in enumerate(h):
        ...
        if "Z_pt20" in plot.name: hi.GetYaxis().SetRangeUser( 0, 45 )
