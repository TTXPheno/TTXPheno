...
#fwlite_ttgamma_LO_order2_15weights_ref_CMS              = Sample.fromDirectory("fwlite_ttgamma_LO_order2_15weights_ref", texName = "tt#gamma",  directory = [os.path.join( gen_dir, "fwlite_ttgamma_LO_order2_15weights_ref" )])
...
#fwlite_ttgammaLarge_LO_order2_15weights_ref_CMS_delphes      = Sample.fromDirectory("fwlite_ttgammaLarge_LO_order2_15weights_ref_delphes", texName = "tt#gamma",  directory = [os.path.join( gen_dir, "fwlite_ttgammaLarge_LO_order2_15weights_ref", "delphes" )], treeName = "Delphes")
...
#fwlite_ttgamma_LO_order2_15weights_ref_CMS_delphes      = Sample.fromDirectory("fwlite_ttgamma_LO_order2_15weights_ref_delphes", texName = "tt#gamma",  directory = [os.path.join( gen_dir, "fwlite_ttgamma_LO_order2_15weights_ref", "delphes" )], treeName = "Delphes")
...
#fwlite_WJetsToLNu_order2_15weights_CMS                  = FWLiteSample.fromDAS("fwlite_WJetsToLNu_order2_15weights", texName = "W+Jets", directory = [os.path.join( gen_dir, "fwlite_WJetsToLNu_order2_15weights" )])
...
fwlite_Zgamma_LO_order2_15weights_CMS               = Sample.fromDirectory("fwlite_Zgamma_LO_order2_15weights",  texName = "Z#gamma",      directory = [os.path.join( gen_dir, "fwlite_Zgamma_LO_order2_15weights" )]) 
...
fwlite_ttgamma_bg_LO_order2_15weights_CMS               = Sample.fromDirectory("fwlite_ttgamma_bg_LO_order2_15weights",  texName = "tt#gamma",      directory = [os.path.join( gen_dir, "fwlite_ttgamma_bg_LO_order2_15weights" )]) 
...
#gen_dir = "/afs/hephy.at/data/rschoefbeck01/TTXPheno/skims/gen/RunII_v01/"
#fwlite_ttgammaLarge_LO_order2_15weights_ref_phase2_CMS              = Sample.fromDirectory("fwlite_ttgammaLarge_LO_order2_15weights_ref", texName = "tt#gamma",  directory = [os.path.join( gen_dir, "fwlite_ttgammaLarge_LO_order2_15weights_ref" )])
...
fwlite_ttZ_ll_LO_order2_15weights_ref_ext_phase2_CMS.xsec14        = 0.5205 * (0.0915 / 0.0565) * (0.7152 / 0.616) #pb ttZ, Z->ll, ttZ gridpack * ttZ NLO Daniel / ttZ LO run.py UFO * ttZ jets 14 TeV / ttZ jets 13 TeV
#check
#16% 14 TeV correction

#fwlite_ttgamma_LO_order2_15weights_ref_phase2_CMS              = Sample.fromDirectory("fwlite_ttgamma_LO_order2_15weights_ref", texName = "tt#gamma",  directory = [os.path.join( gen_dir, "fwlite_ttgamma_LO_order2_15weights_ref" )])
...
#fwlite_ttgammaLarge_LO_order2_15weights_ref_phase2_CMS_delphes      = Sample.fromDirectory("fwlite_ttgammaLarge_LO_order2_15weights_ref_delphes", texName = "tt#gamma",  directory = [os.path.join( gen_dir, "fwlite_ttgammaLarge_LO_order2_15weights_ref", "delphes" )], treeName = "Delphes")
...
#fwlite_ttgamma_LO_order2_15weights_ref_phase2_CMS_delphes      = Sample.fromDirectory("fwlite_ttgamma_LO_order2_15weights_ref_delphes", texName = "tt#gamma",  directory = [os.path.join( gen_dir, "fwlite_ttgamma_LO_order2_15weights_ref", "delphes" )], treeName = "Delphes")
...
#fwlite_ttgamma_bg_LO_order2_15weights_phase2_CMS               = Sample.fromDirectory("fwlite_ttgamma_bg_LO_order2_15weights",  texName = "tt#gamma",      directory = [os.path.join( gen_dir, "fwlite_ttgamma_bg_LO_order2_15weights" )])
