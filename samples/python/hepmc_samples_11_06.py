...
hepmc_directory = "/afs/hephy.at/data/cms08/TTXPheno/HEPMC/11_06"
...
class HEPMCData(object):
    ...
    #pdfs      = ["x"]
    pdfs      = ["0.01", "0.1", "1", "10", "30", "35", "37", "42", "43", "44", "45", "50", "75", "100"]
    ...
    def __init__ ( self, name, directory, root_directory = None, processes = ["GH", "HG", "HH"] ):
        ...
        for pdf in HEPMCData.pdfs:
            try:
                ...
                logger.warning( "Not adding pdf %s process %s", pdf, process )
...
root_directory = "/afs/hephy.at/data/cms01/TTXPheno/skims/gen/RunIInoDelphesIso_v03/11_06"
#root_directory = None
