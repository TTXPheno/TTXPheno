...
#                split_file( filename, args.maxEvents )
    ...
    for dir in [ "/afs/hephy.at/data/cms06/TTXPheno/HEPMC/22_08/ttbar/", "/afs/hephy.at/data/cms06/TTXPheno/HEPMC/22_08/ttbarZ/" ]:
